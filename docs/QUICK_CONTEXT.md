...
- Interaction tab + CBS live across `lib/screens/chat_screen.dart`, `lib/widgets/interaction_drawer.dart`, `lib/features/cbs/`, and `lib/providers/chat_session_provider.dart`.
...
- Interaction presets -> `lib/providers/interaction_preset_provider.dart`
- Agent prompts -> `lib/providers/agent_prompt_preset_provider.dart`
- Session chat variables / interaction state -> `lib/models/chat_session.dart`, `lib/providers/chat_session_provider.dart`
...
- CBS syntax and execution -> `lib/features/cbs/services/cbs_service.dart`
